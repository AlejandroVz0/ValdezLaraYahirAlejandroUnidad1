    ...
    <footer className="bg-neutral-800 dark:bg-zinc-950 text-neutral-300 w-full mt-auto border-t border-neutral-700 transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-5 space-y-4">
            ...
            <p className="text-xs text-neutral-400 leading-relaxed max-w-sm">
              Fundada en 2010 en Ramos Arizpe, Coahuila, somos una empresa familiar y un pilar industrial comprometido con proveer herramientas y materiales de primer nivel para tus proyectos grandes o pequeños.
            </p>
          ...
          <div className="col-span-1 md:col-span-4">
            <h3 className="font-semibold text-sm text-white tracking-wider uppercase mb-4">Navegar Sitio</h3>
            <ul className="grid grid-cols-2 gap-y-2 gap-x-4 text-xs font-semibold text-neutral-400">
              <li>
                <button 
                  onClick={() => handleLinkClick('home')}
                  className="hover:text-amber-500 transition-colors duration-200 text-left cursor-pointer"
                >
                  Inicio
                </button>
              </li>
              ...
              <li>
                <button 
                  onClick={() => handleLinkClick('products', '_OFFERS_')}
                  className="hover:text-amber-500 transition-colors duration-200 text-left cursor-pointer"
                >
                  Ofertas Especiales
                </button>
              ...
              <li>
                <button 
                  ...
                  className="hover:text-amber-500 transition-colors duration-200 text-left cursor-pointer text-amber-500 font-bold"
                >
                  Contacto Directo
                </button>
              </li>
          ...
          {/* Column 3: Redes Sociales / Contact Quick Link */}
          <div className="col-span-1 md:col-span-3">
            <h3 className="font-semibold text-sm text-white tracking-wider uppercase mb-4">Redes y Atención</h3>
            <div className="flex flex-col gap-2 text-xs font-semibold text-neutral-400">
              ...
              <a 
                href="https://wa.me/528441234567?text=Hola,%20quisiera%20pedir%20información%20sobre%20herramientas." 
                target="_blank" 
                rel="noreferrer" 
            ...
            <div className="mt-4 pt-4 border-t border-neutral-700/60">
              ...
              <span className="block text-xs text-neutral-400">Sáb: 8:00 AM - 2:00 PM</span>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-neutral-700 pt-6 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-medium text-neutral-500">
          <div>
            © {currentYear} Ferretería Valdez. Ramos Arizpe, Coahuila, México.
          </div>
